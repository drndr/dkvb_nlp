...
def asc_config(parser):
    ...
    parser.add_argument('--baseline',default='',type=str,required=True,
                        ...
                        choices=['ncl','one','mtl','l2','a-gem','derpp','kan','srk','ewc','hal','ucl','owm','acl','hat','cat','b-cl','classic','ctr','dkv'])
    ...
    parser.add_argument('--key_init',default="full",type=str,required=False,help='which key init strategy to use for dkv', choices=['full','inc','wiki'])
