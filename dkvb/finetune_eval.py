...
from model import BERTwithBottleNeck, ROBERTAwithBottleNeck, DistilBERTwithBottleNeck, BERTbase, ROBERTAbase, DistilBERTbase
...
def main():
    ...
    parser.add_argument('dataset', default='mrpc', type=str, help="Valid choices: mrpc, mnli, qqp, R8, 20ng")
    parser.add_argument("model", default="base", type=str, help="Type of model (base, dkvb")
    ...
    parser.add_argument("--is_frozen", action="store_true", help="freezen base model encoder (default false)")
    ...
    if args.wandb_enabled:
        wandb.init(project="", entity="", name=str(args.dataset)+str(args.epochs)+"e "+str(args.batch_size)+"b "+str(args.lr_global)+"Global "+str(args.lr_values)+"Values "+args.decoder+"Decoder: ")
    ...
    if args.model == 'dkvb':
        ...
        model = BERTbase(n_classes, is_frozen=args.is_frozen)
